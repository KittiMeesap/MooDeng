...
{
    private const string projectId = "testauth01-80ecf-default-rtdb.asia-southeast1"; // You can find this in your Firebase project settings
    private static readonly string databaseURL = $"https://{projectId}.firebasedatabase.app/";
